...
with open("README.md", "w", encoding="utf8") as f:
    ...
    f.write("## 2015\n")
    f.write("| Day | Link | Part 1 Solve Time (s) | Part 2 Solve Time (s) | Total Solve Time (s) | Needs improvement |\n")
    f.write("|:---:|:----:|:---------------------:|:---------------------:|:--------------------:|:-----------------:|\n")
    ...
    for day, res in enumerate(year2015.run_all.run_all()):
        ...
        needs_improvement = "✔️" if res[2] > 5 else ""
        f.write(f"| {day} | [Solution](https://github.com/andrefpoliveira/AdventOfCode/blob/main/2015/day{day}.py) | {first_value} | {second_value} | {third_value} | {needs_improvement} |\n")